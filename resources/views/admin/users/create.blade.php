...
@section('content')
    <div class="container my-5">
        ...
        <form method="POST" action="{{ route('admin.users.store') }}" class="p-4 border rounded shadow-sm"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="password" readonly required>

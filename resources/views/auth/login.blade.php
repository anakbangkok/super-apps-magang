            ...
            <div class="container my-auto">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 shadow-lg border-0 fadeIn3 fadeInBottom"
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-floating mb-4 position-relative">
                                        ...
                                        <span id="togglePassword" class="position-absolute"
                                            style="right: 10px; top: 15px; cursor: pointer;">
                                    ...
                                    <div class="text-center">
                                        <x-primary-button class="btn bg-danger w-100 py-2 mb-3"
                                    ...
                                    {{-- <p class="mt-3 text-sm text-center">
                                        Tidak punya akun?
                                        <a href="{{ route('register') }}" class="text-danger font-weight-bold">Daftar</a>
                                    </p> --}}
                                </form>
                            </div>
                        </div>

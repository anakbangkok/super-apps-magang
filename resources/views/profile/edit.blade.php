    ...
    <div class="container my-5 mx-auto">
        ...
        <div class="tab-content">
                ...
                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penugasan" name="penugasan"
                            value="{{ old('penugasans', auth()->user()->penugasan ? auth()->user()->penugasan->nama_unit_bisnis : '') }}"
                            required readonly>
                    </div>
            ...
            <div class="tab-pane fade" id="password" role="tabpanel">
                <form method="POST" action="{{ route('password.update') }}" class="p-4 border rounded shadow-sm"

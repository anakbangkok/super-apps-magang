...
@section('content')
    ...
    <div class="container my-5">
        ...
        <form action="{{ route('mentors.update', $mentor->id) }}" method="POST" class="p-4 border rounded shadow-sm"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nik" name="nik" value="{{ $mentor->nik }}"
                    required>
            </div>

            <div class="mb-3">
                <label for="nama" class="form-label">Nama</label>
                <input type="text" class="form-control" id="nama" name="name" value="{{ $mentor->name }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                <label for="password" class="form-label">Password (diisi Jika Perlu)</label>
            ...
            <div class="mb-3">
                <label for="password_confirmation" class="form-label">Konfirmasi Password (diisi Jika Perlu)</label>
                <div class="input-group">

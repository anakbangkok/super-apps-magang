...
<ul class="menu-inner py-1">
    ...
    <!-- Laporan Harian -->
    <li
        class="menu-item {{ request()->routeIs('mentor.tim_webs.index') || request()->routeIs('mentor.tim_sosmeds.index') ? 'open' : '' }}">
        ...
        <ul class="menu-sub">
            <!-- Tim Web -->
            <li class="menu-item {{ request()->routeIs('mentor.tim_webs.index') ? 'active' : '' }}">
                <a href="{{ route('mentor.tim_webs.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-book-content"></i>
                    <div data-i18n="Tim Web">Tim Web</div>
                </a>
            </li>
            <!-- Tim Sosmed -->
            <li class="menu-item {{ request()->routeIs('mentor.tim_sosmeds.index') ? 'active' : '' }}">
                <a href="{{ route('mentor.tim_sosmeds.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-book-content"></i>
    ...
    <li class="menu-item {{ request()->routeIs('journal.mentor') ? 'active' : '' }}">
        <a href="{{ route('journal.mentor') }}" class="menu-link">
    ...
    <!-- Feedback -->
    <li class="menu-item {{ request()->routeIs('masukan.mentor') ? 'active' : '' }}">
        <a href="{{ route('masukan.mentor') }}" class="menu-link">

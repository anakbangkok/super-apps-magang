...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/journals/{id}/destroy', [JournalController::class, 'destroy'])->name('journal.admin.destroy');
...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::delete('/admin/journals/{id}', [JournalController::class, 'destroy'])->name('journals.admin.destroy');
